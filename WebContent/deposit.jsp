...
<title>Banking-Portal/Deposit</title>
...
<body>
     <div class="container" id="contain">
            ...
            <header>
                <nav class="navbar">
                    <ul>
                        ...
                        <li><a href=deposit.jsp id="active">Deposit</a></li>
            ...
            <div class="info">
                ...
                <h1 align="center">Deposit Amount</h1><hr>
                <form action="./Deposit" method="post" onsubmit="myFunction()"  autocomplete="off">
                ...
                <input type="submit" value="Deposit" class="logbutton">
                </form>
