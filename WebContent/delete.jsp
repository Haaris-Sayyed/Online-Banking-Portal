...
<title>Banking-Portal/Close A/C</title>
...
<body>
 <div class="container" id="contain">
            ...
            <header>
                <nav class="navbar">
                    <ul>
                        ...
                        <li><a href=delete.jsp id="active">Close A/C</a></li>
            ...
            <div class="info">
                ...
                <h1 align="center">Delete Account</h1><hr>
                <form action="./Delete" method="post"  autocomplete="off">
                <p>Account Number:</p><input type="text" name="accno" required>
                <p>Transaction Pin :</p><input type="password" name="transpin" required><br>
