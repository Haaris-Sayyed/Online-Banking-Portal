...
<title>Banking-Portal/Withdraw</title>
...
<body>
     <div class="container" id="contain">
            ...
            <header>
                <nav class="navbar">
                    <ul>
                        ...
                        <li><a href=withdraw.jsp id="active">Withdraw</a></li>
            ...
            <div class="info">
                ...
                <h1 align="center">Withdraw Amount</h1><hr>
                <form action="./Withdraw" method="post" onsubmit="myFunction()"  autocomplete="off">
                <p>Account Number:</p><input type="text" name="accno" required >
                <p>Transaction Pin :</p><input type="password" name="transpin" required >
                <p>Amount :</p><input type="text" name="amt" required ><br>
               
                <input type="submit" value="Withdraw" class="logbutton">
                </form>
